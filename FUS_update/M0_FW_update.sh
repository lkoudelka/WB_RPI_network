...
gdb-multiarch --eval-command="target remote $1:$2" "/home/rftomas/RPi_network/FUS_update/FUS_Operator_Lite.elf" --eval-command="load /home/rftomas/RPi_network/FUS_update/STM32WB5x_v1.13.2/stm32wb5x_BLE_Stack_full_fw.hex" -batch

gdb-multiarch --eval-command="target remote $1:$2" "/home/rftomas/RPi_network/FUS_update/FUS_Operator_Lite.elf" --eval-command="load /home/rftomas/RPi_network/FUS_update/FUS_Operator_Lite.hex" --eval-command="break main.c:299" --eval-command="c" --eval-command="set {int}0x20000130 = 0x55FF55FF" --eval-command="set {int}0x20000134 = 0xAA00AA00" --eval-command="c" -batch

gdb-multiarch --eval-command="target remote $1:$2" "/home/rftomas/RPi_network/FUS_update/FUS_Operator_Lite.elf" -eval-command="break main.c:299" --eval-command="c" -batch
